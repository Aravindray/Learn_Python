...
while True:
    ...
    # workout
    pygame.draw.lines(window, BLUE, False, ((340, 240), (550, 400), (200, 330)), 2)
    # pygame.draw.lines(window, BLUE, True, ((340, 240), (550, 400), (200, 330)), 2)
    # pygame.draw.aalines(window, BLUE, True, ((340, 240), (550, 400), (200, 330)), 3)
